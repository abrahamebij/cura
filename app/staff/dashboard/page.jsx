        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h1 className="text-2xl font-bold">Welcome, {mockStaff.name}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                <p className="text-base-content/70">requiring your attention</p>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                ...
                <div className="dropdown dropdown-end mt-2 md:mt-0">
                  ...
                  >
                    ...
                    <li>
                      <a onClick={() => setTaskFilter("high")}>High Priority</a>
                    </li>
                    <li>
